...
user function AFINA003(aNotas)
	...
	If lRoboCarga
		...
		cMV_PAR05 := 2			//  Imprime no verso? (setado NÃO)
		cMV_PAR06 := 2			//  Danfe Simplificado? (Setado não)
		cMV_PAR07 := cDataIni	//  Data de
		cMV_PAR08 := cDataFim	//  Data até
		cMV_PAR09 := 1			//  Enviar e-mail novamente (setado não)
