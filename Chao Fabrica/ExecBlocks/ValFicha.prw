	...
	DbGotop()
			...
			If TRBCYV->(!Eof()) 		
				While TRBCYV->(!Eof())
					 ...
					 Help(,, 'Ordem de Produção' ,, 'Já existe a Ficha:' +cFicha+ ' cadastrada para este Apontamento ' + cOP +  ' !', 1,0) 
					 lRet := .F. 
