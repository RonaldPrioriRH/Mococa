...
User Function TReport()
	...
	//Criando a janela
	DEFINE MSDIALOG oDlgPvt TITLE "TReport - Gerador de TOTVS Report" FROM 000, 000  TO nJanAltu, nJanLarg COLORS 0, 16777215 PIXEL
		//Folders / Pastas
...
Static Function fCriaPrw()
	...
	Else
		...
		fWrite(nHdl, '	@obs Função gerada pelo TReport()' + STR_PULA)
		fWrite(nHdl, '/*/' + STR_PULA)
		fWrite(nHdl, '	' + STR_PULA)
