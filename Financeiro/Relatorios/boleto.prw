...
ฑฑบPrograma  ณ RBRADES  บ Autor ณ TOTVS              บ Data ณ  12/11/10   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Impressao de boleto Banco do Brasil e Bradesco.            บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Contas a Receber - Financeiro.                             บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบDica      ณ Criar o campo EE_CARTEIR - C - 2 - Carteira.               บฑฑ
ฑฑบ          ณ Criar o parametro MV_TXJUR=0.05                            บฑฑ
ฑฑบ          ณ Preencher o campo EE_CODEMP com 6 digitos.                 บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑบ          ณ Alteracao em 28/02/11.                                     บฑฑ
ฑฑบ          ณ Criar o campo A1_BOLETO - C - 1 - SIM ou NAO.              บฑฑ
ฑฑบ          ณ Criar o campo A1_BCO1 - Codigo do Banco Bradesco ou Brasil.บฑฑ
ฑฑบ          ณ Definido que sempre que A1_BOLETO = SIM sera Bradesco e    บฑฑ
ฑฑบ          ณ impressao na empresa e A1_BOLETO = NAO sera Brasil e       บฑฑ
ฑฑบ          ณ impressao no banco.                                        บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
//ณ Cria a tela para selecao dos titulos.                             ณ
...
While TRB->(!Eof())
	...
	If !Empty(TRB->E1_OK)
		...
		If !dbSeek(xFILIAL("SEE")+cPortado+cAgencia+cConta)
			MsgStop("Banco : "+TRB->E1_PORTADO + " Agencia : " + TRB->E1_AGEDEP + " Conta : " + TRB->E1_CONTA +" Nใo encontrado. Verifique os parโmetros informados.","Aten็ใo")
			Return()
		EndIf
...
// 			Iif(ALLTRIM(TRB->E1_PARCELA) <> '',ALLTRIM(TRB->E1_NUM)+"-"+ALLTRIM(TRB->E1_PARCELA),ALLTRIM(TRB->E1_NUM)),;  //1-N๚mero do titulo			
		...
		If !_lReimprime   //SE OPCAO REIPRESSAO FOR VERDADEIRA SERA MONTADO O BOLETO SEM GERAR UM NOVO NUMERO
			...
			IF dbSeek(TRB->E1_FILIAL+TRB->E1_PREFIXO+TRB->E1_NUM+TRB->E1_PARCELA+TRB->E1_TIPO)
				...
				MsUnlock()
            ELSE
                MSGBOX("Registro nใo encontrado (SE1) => "+TRB->E1_PREFIXO+TRB->E1_NUM+TRB->E1_PARCELA+TRB->E1_TIPO)
            ENDIF
			End Transaction
		EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบFuncao    ณ xInvAll  บ Autor ณ TOTVS              บ Data ณ  00/00/00   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Rotina para inverter a marcacao de todos os registros.     บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ xProcessa().                                               บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบFuncao    ณ xInvReg  บ Autor ณ Microsiga          บ Data ณ  00/00/00   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Rotina para inverter a marcacao do registro posicionado.   บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ xProcessa().                                               บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบFuncao    ณ CriaArq  บ Autor ณ Microsiga          บ Data ณ  00/00/00   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Funcao para criacao do arquivo temporario.                 บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
//ณ Armazena no array aEstru a estrutura dos campos da tabela.      ณ
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Armazena no array aCampos o nome, picture e descricao dos campos. ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
AADD( aCampos ,{"E1_OK"       ,""," "           ," "})
...
AADD( aCampos ,{"E1_NUMBCO"   ,"","Nบ no Banco" ,PesqPict("SE1","E1_NUMBCO")})
...
//ณ Cria o arquivo fisicamente no diretorio "/StartPath/".                                    ณ
//ณ Se o 2o parametro dFwTemporaryTableab for .T. cria o arquivo, se .F. retorna um nome aleatorio.   ณ
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Permite o uso do arquivo criado dentro do protheus.             ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
Use &cArqTRB1 Alias TRB NEW

//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Cria os indices para o arquivo.                                 ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Agrega um arquivo de indice a um Alias ativo no sistema.        ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
dbSelectArea("TRB")
...
ฑฑณFun…o    ณ  AjustSX1    ณ Autor                         ณ Data ณ 30/11/01 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Adiciona perguntas no SX1                                      ณฑฑ
...
//ณ Variavel lPyme utilizada para Tratamento do Siga PyME        ณ
...
aadd(aReg,{{"X1_GRUPO",cPerg},{"X1_ORDEM","02"},{"X1_PERGUNT","Prefixo at้"}	,{"X1_VARIAVL","mv_ch2"},{"X1_TIPO","C"},{"X1_TAMANHO",3}, {"X1_DECIMAL",0},{"X1_PRESEL",0},{"X1_GSC","G"},{"X1_VAR01","mv_par02"},{"X1_F3",""},{"X1_PYME","S"},{"X1_DEF01",""},{"X1_DEF02",""}})
...
aadd(aReg,{{"X1_GRUPO",cPerg},{"X1_ORDEM","04"},{"X1_PERGUNT","N. Fiscal At้"}	,{"X1_VARIAVL","mv_ch4"},{"X1_TIPO","C"},{"X1_TAMANHO",9}, {"X1_DECIMAL",0},{"X1_PRESEL",0},{"X1_GSC","G"},{"X1_VAR01","mv_par04"},{"X1_F3",""},{"X1_PYME","S"},{"X1_DEF01",""},{"X1_DEF02",""}})
...
aadd(aReg,{{"X1_GRUPO",cPerg},{"X1_ORDEM","09"},{"X1_PERGUNT","Bordero At้"}	,{"X1_VARIAVL","mv_ch9"},{"X1_TIPO","C"},{"X1_TAMANHO",6}, {"X1_DECIMAL",0},{"X1_PRESEL",0},{"X1_GSC","G"},{"X1_VAR01","mv_par09"},{"X1_F3",""},{"X1_PYME","S"},{"X1_DEF01",""},{"X1_DEF02",""}})
...
aadd(aReg,{{"X1_GRUPO",cPerg},{"X1_ORDEM","12"},{"X1_PERGUNT","Cliente At้"}	,{"X1_VARIAVL","mv_chc"},{"X1_TIPO","C"},{"X1_TAMANHO",6}, {"X1_DECIMAL",0},{"X1_PRESEL",0},{"X1_GSC","G"},{"X1_VAR01","mv_par12"},{"X1_F3","SA1"},{"X1_PYME","S"},{"X1_DEF01",""},{"X1_DEF02",""}})
aadd(aReg,{{"X1_GRUPO",cPerg},{"X1_ORDEM","13"},{"X1_PERGUNT","Loja Cli. At้"}	,{"X1_VARIAVL","mv_chd"},{"X1_TIPO","C"},{"X1_TAMANHO",2}, {"X1_DECIMAL",0},{"X1_PRESEL",0},{"X1_GSC","G"},{"X1_VAR01","mv_par13"},{"X1_F3",""},{"X1_PYME","S"},{"X1_DEF01",""},{"X1_DEF02",""}})
...
aadd(aReg,{{"X1_GRUPO",cPerg},{"X1_ORDEM","15"},{"X1_PERGUNT","Vencimento At้"}	,{"X1_VARIAVL","mv_chf"},{"X1_TIPO","D"},{"X1_TAMANHO",8}, {"X1_DECIMAL",0},{"X1_PRESEL",0},{"X1_GSC","G"},{"X1_VAR01","mv_par15"},{"X1_F3",""},{"X1_PYME","S"},{"X1_DEF01",""},{"X1_DEF02",""}})
aadd(aReg,{{"X1_GRUPO",cPerg},{"X1_ORDEM","16"},{"X1_PERGUNT","Instru็ใo 1"}	,{"X1_VARIAVL","mv_chg"},{"X1_TIPO","C"},{"X1_TAMANHO",50},{"X1_DECIMAL",0},{"X1_PRESEL",0},{"X1_GSC","G"},{"X1_VAR01","mv_par16"},{"X1_F3",""},{"X1_PYME","S"},{"X1_DEF01",""},{"X1_DEF02",""}})
aadd(aReg,{{"X1_GRUPO",cPerg},{"X1_ORDEM","17"},{"X1_PERGUNT","Instru็ใo 2"}	,{"X1_VARIAVL","mv_chh"},{"X1_TIPO","C"},{"X1_TAMANHO",50},{"X1_DECIMAL",0},{"X1_PRESEL",0},{"X1_GSC","G"},{"X1_VAR01","mv_par17"},{"X1_F3",""},{"X1_PYME","S"},{"X1_DEF01",""},{"X1_DEF02",""}})
aadd(aReg,{{"X1_GRUPO",cPerg},{"X1_ORDEM","18"},{"X1_PERGUNT","Instru็ใo 3"}	,{"X1_VARIAVL","mv_chi"},{"X1_TIPO","C"},{"X1_TAMANHO",50},{"X1_DECIMAL",0},{"X1_PRESEL",0},{"X1_GSC","G"},{"X1_VAR01","mv_par18"},{"X1_F3",""},{"X1_PYME","S"},{"X1_DEF01",""},{"X1_DEF02",""}})
aadd(aReg,{{"X1_GRUPO",cPerg},{"X1_ORDEM","19"},{"X1_PERGUNT","Emissใo de"}		,{"X1_VARIAVL","mv_chj"},{"X1_TIPO","D"},{"X1_TAMANHO",8}, {"X1_DECIMAL",0},{"X1_PRESEL",0},{"X1_GSC","G"},{"X1_VAR01","mv_par19"},{"X1_F3",""},{"X1_PYME","S"},{"X1_DEF01",""},{"X1_DEF02",""}})
aadd(aReg,{{"X1_GRUPO",cPerg},{"X1_ORDEM","20"},{"X1_PERGUNT","Emissใo At้"}	,{"X1_VARIAVL","mv_chk"},{"X1_TIPO","D"},{"X1_TAMANHO",8}, {"X1_DECIMAL",0},{"X1_PRESEL",0},{"X1_GSC","G"},{"X1_VAR01","mv_par20"},{"X1_F3",""},{"X1_PYME","S"},{"X1_DEF01",""},{"X1_DEF02",""}})
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ  Cnab_4      ณ Autor                         ณ Data ณ 30/11/01 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
