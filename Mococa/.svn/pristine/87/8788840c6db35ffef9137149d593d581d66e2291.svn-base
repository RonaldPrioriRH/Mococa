...
ฑฑบPrograma  ณ AGLT029  บ Autor ณ TOTVS                 บ Data da Criacao  ณ 04/02/2009                						บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯอออออออออออออออออออออออสออออออออออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบDescricao ณ Rotina desenvolvida para possibilitar o cadastramento da Recpecao de Leite do mes todo de um produtor        บฑฑ
ฑฑบ          ณ                     												                               				บฑฑ
...
private aValida		:= {"vldSet(cSetor)","vldVeicul(cVeicul)","vldLinRot(cLinRot)"}
private cCadastro 	:= "Recep็ใo de Leite"
private aRotina   := MenuDef()
private cAlias := "ZLD"
private aCores := getCores()
private lMensal:=.f.  // Mensal

// Mensal
if LEFT(XFILIAL("ZLD"),1) == "1"
	If MsgYesNo("Efetuar Lancamentos Diarios?")
		lMensal:=.f.
	else
		lMensal:=.t.
	endif
...
local cTitulo := "Recepcao de Leite"
...
private oLteBom,oLteAci,oSetor,oLinRota,nDif
...
private cLinRot		:= if(nOpc==3,Criavar("ZLD_LINROT"),ZLD->ZLD_LINROT)  //space(TamSX3("ZLD_LINROT")[1])
private cTipLR		:= if(nOpc==3,space(TamSX3("ZLD_TP_RL")[1]),ZLD->ZLD_TP_RL)
...
private nLeiteAci 	:= 0
private nLtDif := 0
private bVldLin		:= {|| linOK()}
private bVldTela	:= {|| tudoOK()}
private lConfirmou 	:= .F.
private nPosRetiro,nPosLoja,nPosProdu,nPosLocal,nPosQtdBom,nPosQtdAcid,nPosNomRet,nPosDataCol //Mensal
...
private lPlataform := .f.


//Mensal
if lMensal 
	aNoFields	:= {"ZLD_TICKET","ZLD_DTLANC","ZLD_SETOR","ZLD_LINROT","ZLD_TP_RL","ZLD_FRETIS","ZLD_LJFRET","ZLD_VEICUL","ZLD_MOTOR","ZLD_KM","ZLD_CODREC","ZLD_PRODUT","ZLD_LOCAL","ZLD_TOTREC","ZLD_STATUS","ZLD_USER","ZLD_TOTBOM","ZLD_TOTACI","ZLD_TOTAL","ZLD_QTDACI","ZLD_VFRELT","ZLD_VFREPR","ZLD_TQ_LT","ZLD_ALI_WT","ZLD_REC_WT"}
	aYesFields	:= {"ZLD_RETIRO","ZLD_RETILJ","ZLD_PRODUT","ZLD_LOCAL","ZLD_QTDBOM","ZLD_DCRRET","ZLD_TQ_LT","ZLD_DTCOLE"}
else
	aNoFields	:= {"ZLD_TICKET","ZLD_DTLANC","ZLD_SETOR","ZLD_LINROT","ZLD_TP_RL","ZLD_FRETIS","ZLD_LJFRET","ZLD_VEICUL","ZLD_MOTOR","ZLD_KM","ZLD_CODREC","ZLD_PRODUT","ZLD_LOCAL","ZLD_TOTREC","ZLD_STATUS","ZLD_USER","ZLD_TOTBOM","ZLD_TOTACI","ZLD_TOTAL","ZLD_DTCOLE","ZLD_QTDACI","ZLD_VFRELT","ZLD_VFREPR","ZLD_ALI_WT","ZLD_REC_WT"}
	aYesFields	:= {"ZLD_RETIRO","ZLD_RETILJ","ZLD_PRODUT","ZLD_LOCAL","ZLD_QTDBOM","ZLD_DCRRET","ZLD_TQ_LT"}
endif
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Validacao - Nao alterea apos 2 dias do lancamento
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
if nOpc == 4
	if (date() - ZLD->ZLD_DTLANC ) > 2
		xmaghelpfis("Atencao ","Altera็ใo nใo permitida! Lan็amento realizado a mais de dois dias e nใo pode ser modificado!","Nenhuma, por nao ter permissใo!")
		return
	endif
endif
...
//Mensal
if lMensal
	nPosDataCol	:= ascan(aHeader,{|x| alltrim(x[2]) == "ZLD_DTCOLE"})
endif
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Tela do model 2 - Rececpcao de Leite                 ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
...
@ 1.6,00.7 		SAY "Data Coleta"
@ 1.5,04.7  	MSGET dDtColeta  Valid CheckSX3("ZLD_DTLANC") .and.  VldUser('ZLD_DTLANC') WHEN (nOpc==3)
@ 1.6,12.2  	SAY "Data Lanc."
@ 1.5,16.0 		MSGET dData Valid CheckSX3("ZLD_DTLANC") .and.  VldUser('ZLD_DTLANC') WHEN .F.

@ 2.6,00.7 	SAY "Transport."
@ 2.5,04.7  MSGET cFretist Valid iif(empty(cFretist),.t.,CheckSX3("ZLD_FRETIS") .and.  VldUser('ZLD_FRETIS') .and. vldFretist(cFretist,cLjFret) .and. getDFret(cFretist,cLjFret)) WHEN (nOpc==3)  F3 "SA2_L3"
@ 2.5,09.5  MSGET cLjFret  Valid iif(empty(cLjFret) ,.t.,CheckSX3("ZLD_LJFRET") .and.  VldUser('ZLD_LJFRET') .and. vldFretist(cFretist,cLjFret) .and. getDFret(cFretist,cLjFret)) WHEN (nOpc==3)
@ 2.5,12.2  MSGET cDescFret  WHEN .F.

@ 3.6,00.5 	SAY "Setor"
@ 3.5,04.7  MSGET oSetor var cSetor Valid iif(empty(cSetor),.t.,CheckSX3("ZLD_SETOR") .and.  VldUser('ZLD_SETOR') .and.  vldSet(cSetor)) .and. getNwTicket() WHEN (nOpc==3) F3 "ZL2_01"
@ 3.5,09.5  MSGET cDescSet  WHEN .F.

@ 4.6,00.7  SAY "Linha/Rota"
@ 4.5,04.7 	MSGET oLinRota var cLinRot  Valid iif(empty(cLinRot),.t.,CheckSX3("ZLD_LINROT") .and.  VldUser('ZLD_LINROT') .and. vldLinRot(cLinRot)) WHEN (nOpc==3) F3 "ZL3_02"
@ 4.5,09.5  MSGET cDescLin  WHEN .F.
@ 4.6,23.1  SAY "Total KM"
@ 4.5,26.1  MSGET nTotKm Picture "@E 9,999.99" Valid iif(empty(ntotkm),.t.,CheckSX3("ZLD_KM") .and.  VldUser('ZLD_KM') ) WHEN (nOpc==3)

@ 5.6,00.7 	SAY "Motorista"
@ 5.5,04.7  MSGET cMotor Valid iif(empty(cMotor),.t.,CheckSX3("ZLD_MOTOR") .and.  VldUser('ZLD_MOTOR') .and. vldMotor(cMotor) ) WHEN (nOpc==3) F3 "ZL0_02"
@ 5.5,09.5  MSGET cDescMot  WHEN .F.

if lFlat
	@ 5.6,23.1  	SAY "Veiculo"
	@ 5.5,26.1  	MSGET cVeicul Picture PesqPict("ZLD","ZLD_VEICUL") Valid iif(empty(cVeicul),.t., CheckSX3("ZLD_VEICUL") .and.  VldUser('ZLD_VEICUL') .and. vldVeicul(cVeicul)) WHEN (nOpc==3)  F3 "ZL4_01"
	@ 5.5,30.1 		MSGET cPlacaVeic  WHEN .F.
else
	@ 5.6,26.7  	SAY "Veiculo"
	@ 5.5,29.2  	MSGET cVeicul Picture PesqPict("ZLD","ZLD_VEICUL") Valid iif(empty(cVeicul),.t.,CheckSX3("ZLD_VEICUL") .and.  VldUser('ZLD_VEICUL') .and. vldVeicul(cVeicul)) WHEN (nOpc==3)  F3 "ZL4_01"
	@ 5.5,34.2 		MSGET cPlacaVeic  WHEN .F.
endif

nLeiteBom  := nVolAnt+getTotCol()
nTotCodRec := getTotCol()
nLtDif := nTotBom-nLeiteBom

DEFINE FONT oFont1 NAME "Tahoma" BOLD
@ 6.6,00.7 SAY "Ticket" FONT oFont1
@ 6.5,04.7 MSGET cTicket Picture PesqPict("ZLD","ZLD_TICKET") Valid CheckSX3("ZLD_TICKET") .and.  VldUser('ZLD_TICKET') .and. !isExist(cTicket,"ZLD","ZLD_TICKET") WHEN (nOpc==3) FONT oFont1
@ 6.5,10.0 SAY "Volume no Veiculo"
@ 6.5,15.7 MSGET nTotBom Picture "@E 999,999.99"  WHEN ((nOpc==3).and.nVolAnt==0) SIZE 50,7
@ 6.5,22.3 SAY "Vol. Coletado"
@ 6.5,26.1 MSGET oLteBom var nLeiteBom Picture "@E 999,999.99"  WHEN .F. SIZE 50,7
@ 6.5,32.5 SAY "Diferenca"
@ 6.5,35.5 MSGET nDif var nLtDif Picture "@E 999,999.99"  WHEN .F.  SIZE 50,7


oGet := MSGetDados():New(aPosObj[2,1]+30,aPosObj[2,2],aPosObj[2,3]-10,aPosObj[2,4],nOpc,"Eval(bVldLin)","Eval(bVldTela)","",((nOpc == 3) .or. (nOpc == 4)),NIL,NIL,NIL,LINHAS)

// RODAPE DA TELA
@aPosObj[2,3],005 SAY "Total de Volume do Lancamento:"  Pixel of oDlg
@aPosObj[2,3],090 MSGET oTotCodRec var nTotCodRec Picture "@E 999,999,999"  WHEN .F. Pixel of oDlg
...
if lConfirmou
	...
	BEGIN TRANSACTION
	if nOpc == 3
		//cCodRec := getSxeNum("ZLD","ZLD_CODREC")
		//cCodRec := getNumRec()
		insZLD(aCols)
	elseif nOpc == 4
		//Verifica se houve alteracao
		if alterou(aColsAux,aCols)
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Verifica se a linha foi excluida                     ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
if aTail(aCols[n])
	return .T.
endif
...
if len(aCols) > 1
	...
	lRet := nIndex == 0
	if !lRet .and. !lMensal // Mensal
		xmaghelpfis("Retiro","Produtor jแ incluํdo neste recebimento. Nao pode haver dois produtores na mesma coleta!","Lance todos os volumes num s๓ Produtor!")
		return lRet
	endif
endif

//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Verifica se o retiro esta dentro da linha informada  ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
if !aTail(aCols[n])  
	cLinhaRota := Posicione("SA2",1,xFilial("SA2")+aAux[nPosRetiro]+aAux[nPosLoja],"A2_L_LI_RO")
	lRet := cLinhaRota == cLinRot
	if !lRet
		xmaghelpfis("Atencao","Produtor informado nใo pertence a linha/rota informada","Selecione um Produtor que seja da linha informada.")
		return lRet
	endif
	cBlq := Posicione("SA2",1,xFilial("SA2")+aAux[nPosRetiro]+aAux[nPosLoja],"A2_MSBLQL")
	lRet := cBlq == "2"//2=Liberado; 1=Bloqueado
	if !lRet
		xmaghelpfis("Atencao","Produtor informado nใo estแ ativo no SIGSIF.","Ative o Produtor no cadastro de Fornecedores ou selecione outro produtor!")
		return lRet
	endif
endif
...
if lMensal
	for y:=1 to len(acols)
		aCols[y,nPosRetiro]	:=	aCols[1,nPosRetiro]
		aCols[y,nPosLoja]	:=	aCols[1,nPosLoja]
		aCols[y,nPosNomRet]	:=	aCols[1,nPosNomRet]
	next y
endif

if aAux[nPosQtdbom] <= 0
	xmaghelpfis("Atencao","Quantidade de leite deve ser informada!","Informe a quantidade de leite do produtor!")
	return .f.
endif
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัอออออออออออออออออออออออหออออออออออออออออออัออออออออออออออออออออออออออออออออออออออออออออออออปฑฑ
ฑฑบPrograma  ณTudoOK    บ Autor ณ Jeovane               บ Data da Criacao  ณ 11/09/2008                						บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯอออออออออออออออออออออออสออออออออออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
if lPlataforma
	lRet := ((!empty(dDtColeta))  .and.  (!empty(cLinRot)) .and.  (!empty(cSetor)) .and. (!empty(nTotBom))   )
else
	lRet := ((!empty(cFretist)) .and. (!empty(cMotor)) .and.  (!empty(cLjFret)) .and. (!empty(dDtColeta))  .and.  (!empty(cLinRot)) .and.  (!empty(cSetor))   )
endif

if !lRet
	xmaghelpfis("Atencao","Existem campos obrigat๓rios nใo preenchidos!","Preencha os campos obrigatorios!")
endif
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัอออออออออออออออออออออออหออออออออออออออออออัออออออออออออออออออออออออออออออออออออออออออออออออปฑฑ
ฑฑบPrograma  ณvldSet    บ Autor ณ Jeovane               บ Data da Criacao  ณ 11/09/2008                						บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯอออออออออออออออออออออออสออออออออออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบDescricao ณ Funcao usada para validar setor digitado na tela de Recepcao de leite                                        บฑฑ
ฑฑบ          ณ                  												                               				บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Implantacao das rotinas referente a Gestao do Leite.                						                    บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
if !empty(cSetor)
	dbSelectArea("ZL2")
	dbSetOrder(1)
	lRet :=  dbSeek(xFilial("ZL2")+cSetor)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัอออออออออออออออออออออออหออออออออออออออออออัออออออออออออออออออออออออออออออออออออออออออออออออปฑฑ
ฑฑบPrograma  ณvldLinRot บ Autor ณ Jeovane               บ Data da Criacao  ณ 11/09/2008                						บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯอออออออออออออออออออออออสออออออออออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบDescricao ณ Funcao usada para validar linha rota digitado na tela de Recepcao de leite                                   บฑฑ
ฑฑบ          ณ                  												                               				บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Implantacao das rotinas referente a Gestao do Leite.                						                    บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
/*/
static function vldLinRot(cLinRot)
local lRet := .T.
local aArea := getArea()
...
if !empty(ALLTRIM(cLinRot))
	dbSelectArea("ZL3")
	dbSetOrder(1)
	lRet := dbSeek(xFilial("ZL3")+cLinRot)
	
	if lRet
		cTipLR  := ZL3->ZL3_TIPO
		lPlataforma := IIF(ZL3->ZL3_PLATAF=="S",.t.,.f.)
		if !lPlataforma
			cVeicul := ZL3->ZL3_VEICUL
			vldVeicul(cVeicul)
			cMotor := POSICIONE("ZL4",1,XFILIAL("ZL4")+ZL3->ZL3_VEICUL,"ZL4_MOTORI")
			vldMotor(cMotor)
		endif
	...
	if lRet
		...
		if !lRet
			xmaghelpfis("Atencao","O Setor selecionado nao pertence a essa Linha","Selecione uma linha que faca parte do setor informado!")
			oLinRota:SetFocus()
		endif
	endif
	
	//Mensal
	if lRet .and. !lPlataforma .and. lMensal
		xmaghelpfis("Atencao","Somente plataformas podem ser lancadas mensalmente!","Selecione uma plataforma ou entre no modo de Recepcao de Leite Diaria.")
		lRet:=.f.
	endif
...
if lRet .AND. LEFT(XFILIAL("ZLD"),1)=="1"
	if lMensal
			getDatas()
	else
			getProdutores()
...
local lRet := .T.
local cLoja := if(!empty(cLjFret),cLjFret,"0001") //Seta var loja com loja padrao caso a mesma esteja vazia
local aArea := getArea()

if !empty(cFretist)
	dbSelectArea("SA2")
	dbSetOrder(1)
	lRet := dbSeek(xFilial("SA2")+cFretist+cLoja)
...
if !empty(cVeicul)
	dbSelectArea("ZL4")
	dbSetOrder(1)
	lRet := dbSeek(xFilial("ZL4")+cVeicul)
	if lRet
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัอออออออออออออออออออออออหออออออออออออออออออัออออออออออออออออออออออออออออออออออออออออออออออออปฑฑ
ฑฑบPrograma  ณvldMotor  บ Autor ณ Jeovane               บ Data da Criacao  ณ 11/09/2008                						บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯอออออออออออออออออออออออสออออออออออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
/*/
static function vldMotor(cMotor)
local lRet := .T.
local aArea := getArea()
...
if !empty(cMotor)
	...
	dbSetOrder(1)
	dbgotop()
	lRet := dbSeek(xFilial("ZL0")+cMotor)
	
	if lRet .AND. !lPlataforma
		if ZL0->ZL0_FRETIS != cFretist
			xmaghelpfis("Atencao - Validacao","O Motorista selecionado nao pertence ao Transportador!","Selecione um motorista relacionado ao Transportador!")
			lRet:=.T.
		endif
...
Local aCores:= {{ 'ZLD->ZLD_STATUS==" "', 'BR_VERDE'		},;
...
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
for i := 1 to len(aCols)
	if ((!empty(aCols[i,nPosRetiro])) .and. (!empty(aCols[i,nPosLoja])) )
		aCols[i,nPosNomRet] := Posicione("SA2",1,xFilial("SA2")+aCols[i,nPosRetiro]+aCols[i,nPosLoja],"A2_NOME")
	endif
next i
...
dbSelectArea("ZL3")
dbSetOrder(1)
dbSeek(xFilial("ZL3")+cLinRot+cTipLR)
cTpPagFret := ZL3->ZL3_FRMPG
if cTpPagFret == "L"
	nVrLitro := ZL3->ZL3_VLRFRT
elseif cTpPagFret == "K"
	nValKM := ZL3->ZL3_VLRFRT
elseif cTpPagFret == "F"
	nValDia := ZL3->ZL3_VLRFRT
endif

//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Grava  Mov.Interno caso for inclusao                 ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
If inclui .OR. altera
	bOk := gerMI(cTicket,3)	
endif
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Se gravou Mi entrao grava recepcao                   ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
if bOk
	cCodRec := getnumrec()
	...
	for i := 1 to len(aRegs)
		if !aTail(aRegs[i])	 //Verifica se item esta deletado
			if (!empty(aRegs[i,nPosRetiro]) .and. !empty(aRegs[i,nPosLoja]))
				nProp  := (aRegs[i,nPosQtdBom]) / (nTotBom) //Acha proporcao pelo volume do produtor e volume total
				recLock("ZLD",.T.)
				ZLD->ZLD_FILIAL		:= 	xFilial("ZLD")
				ZLD->ZLD_CODREC		:= 	cCodRec
				ZLD->ZLD_TICKET		:=  cTicket
				...
				// Mensal
				if lMensal
					ZLD->ZLD_DTCOLE	:= aRegs[i,nPosDataCol]
					ZLD->ZLD_FILENT		:= U_GetFilEnt(	aRegs[i,nPosRetiro],aRegs[i,nPosLoja],aRegs[i,nPosDataCol])
				else
					ZLD->ZLD_DTCOLE		:= 	dDtColeta                                                              
					ZLD->ZLD_FILENT		:= U_GetFilEnt(	aRegs[i,nPosRetiro],aRegs[i,nPosLoja],dDtColeta)
				endif
				ZLD->ZLD_SETOR 		:= 	cSetor
				ZLD->ZLD_LINROT		:= 	cLinRot
				ZLD->ZLD_TP_RL		:= 	cTipLR
				ZLD->ZLD_RETIRO		:= 	aRegs[i,nPosRetiro]
				ZLD->ZLD_RETILJ		:= 	aRegs[i,nPosLoja]
				ZLD->ZLD_DCRRET		:=  aRegs[i,nPosNomRet]
				ZLD->ZLD_FRETIS		:=	cFretist
				ZLD->ZLD_LJFRET		:= 	cLjFret
				ZLD->ZLD_VEICUL		:= 	cVeicul
				ZLD->ZLD_MOTOR		:= 	cMotor
				ZLD->ZLD_QTDBOM		:= 	aRegs[i,nPosQtdBom]
				ZLD->ZLD_KM			:= 	nTotKm
				ZLD->ZLD_STATUS		:= 	" "
				ZLD->ZLD_USER 		:= cUser
				ZLD->ZLD_TOTBOM		:= nTotBom   
				...
				//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
				if cTpPagFret == "L"
					nVrFrete := nVrLitro *  aRegs[i,nPosQtdBom]
					ZLD->ZLD_VFRELT := nVrLitro
					ZLD->ZLD_VFREPR := nVrFrete
				elseif cTpPagFret == "K"
					nValTot := nTotkm * nValKM
					ZLD->ZLD_VFRELT := (nValTot * nProp) / aRegs[i,nPosQtdBom]
					ZLD->ZLD_VFREPR := (nValTot * nProp)
				elseif cTpPagFret == "F"
					ZLD->ZLD_VFRELT := (nValDia * nProp) / aRegs[i,nPosQtdBom]
	...
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณ Salva numero do ticket                               ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	//putMv("LT_TICKET",strzero(val(cTicket)+1,6))
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัอออออออออออออออออออออออหออออออออออออออออออัออออออออออออออออออออออออออออออออออออออออออออออออปฑฑ
ฑฑบPrograma  ณGERMI     บ Autor ณ Abrahao               บ Data da Criacao  ณ 07/10/2008                						บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯอออออออออออออออออออออออสออออออออออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
/*/
Static Function gerMI(cCod,noption)
Local _aAutoSD3 := {}
Local cTm := getmv("LT_ENTTM")
Local cProduto := getmv("LT_ENTPRO")
...
// VALIDAR ARMAZEM (LOCAL) E CRIAR
// INSERT INTO SB2010(B2_FILIAL,B2_COD,B2_LOCAL,B2_USAI,B2_DINVENT,R_E_C_N_O_) VALUES ( &apos;01&apos;,&apos;08000000004    &apos;,&apos;G0&apos;,&apos;20081119&apos;,&apos;20081119&apos;,       303)
...
if nOption == 5 // excluir
	...
	_cQuery += " WHERE "
	_cQuery += " D_E_L_E_T_ = ' '"
	_cQuery += " AND D3_EMISSAO = '"+DTOS(dDtcoleta)+"'"
	_cQuery += " AND D3_ESTORNO != 'S'"
	_cQuery += " AND D3_L_ORIG = '"+cCod+"'"  
	_cQuery += " AND D3_L_SETOR = '"+cSetor+"'"  
	...
	if TRC->(!Eof())
		...
		dbselectarea("SD3")
		dbsetorder(2)
		dbseek(xfilial("SD3")+TRC->D3_DOC+TRC->D3_COD)
		
		AAdd( _aAutoSD3,{"D3_NUMSEQ"   ,  SD3->D3_NUMSEQ	, nil } )	// Tipo do Movimento Interno	: Obrigatorio
		AAdd( _aAutoSD3,{"D3_CHAVE"		, SD3->D3_CHAVE	, nil } )	// Codigo do Produto			: Obrigatorio
		AAdd( _aAutoSD3,{"D3_COD"		, SD3->D3_COD	, nil } )	// Unidade de Medida			: Obrigatorio
		AAdd( _aAutoSD3,{"D3_DOC"	    , SD3->D3_DOC	, nil } )	// Quantidade de Leite
		AAdd( _aAutoSD3,{"D3_CF"	    , SD3->D3_CF , nil } )	// Almoxarifado					: Obrigatorio
		AAdd( _aAutoSD3,{"INDEX"	    , 4 , nil } )	// Almoxarifado					: Obrigatorio
		dbsetorder(4)
		
		//aAux:=CalcEst(SD3->D3_COD,SD3->D3_LOCAL,SD3->D3_EMISSAO)
		
		//if aAux[1] > 0
			lMsErroAuto := .F.
			Pergunte("MTA240",.F.) // Chama perguntas da rotina para evitar erros no Sigaauto
			MSExecAuto({|x,y| Mata240(x,y)},_aAutoSD3,5)
			/*If lMsErroAuto //.or. existMi(cCod,dDtcoleta,cSetor)
				MOSTRAERRO()
				xmaghelpfis("Erro","Erro ao excluir Recepcao de Leite devido a um erro ocorrido ao excluir Estoque!","Tente novamente, se o erro persistir comunique urgentemente ao Suporte!")
				//ACSendMail(GetMv("MV_WFAUTUS"), GetMv("MV_WFAUTSE"), GetMv("MV_WFPOP3"), "Workflow", "sistema@laticinio.com.br", "Gestao De Leite - Erro!", "Nao foi possivel gerar estoque! Saida "+cTicket)
				bret:=.f.
			Endif
			*/
		//else
		//	xmaghelpfis("Falha","Nao foi possivel efetuar a rotina por nao existir saldo em estoque para realizar essa operacao.","Verifique no modulo de Estoque o motivo da falta de saldo.")
		//	bret:=.f.
		//Endif
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัอออออออออออออออออออออออหออออออออออออออออออัออออออออออออออออออออออออออออออออออออออออออออออออปฑฑ
ฑฑบPrograma  ณEXISTMI   บ Autor ณ Abrahao               บ Data da Criacao  ณ 09/10/2008                						บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯอออออออออออออออออออออออสออออออออออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
/*/
static function delZLD(aRegs)
local aArea := getArea()
Local lContinue:=.f.

// -----------------------------------------------------------
// Se nao houver mais nenhum lancamento com esse ticket, entao 
// Deleta o Movimento Interno e continua exclusao
// -----------------------------------------------------------
if NoMoreTicket(cTicket,cSetor)
	if gerMI(cTicket,5)
		lContinue := .t.
	endif
else
...
if lContinue                               
	dbSelectArea("ZLD")
	dbSetOrder(2) //ZLD_FILIAL+ZLD_CODREC+ZLD_RETIRO+ZLD_RETILJ
	for i := 1 to len(aRegs)
		if dbSeek(xFilial("ZLD")+cCodRec + aRegs[i,nPosRetiro] + aRegs[i,nPosLoja])
			recLock("ZLD",.F.)
			ZLD->(dbDelete())
			ZLD->(MSUnlock())
			ZLD->(dbCommit())
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัอออออออออออออออออออออออหออออออออออออออออออัออออออออออออออออออออออออออออออออออออออออออออออออปฑฑ
ฑฑบPrograma  ณalterou   บ Autor ณ Jeovane               บ Data da Criacao  ณ 11/09/2008                						บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯอออออออออออออออออออออออสออออออออออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัอออออออออออออออออออออออหออออออออออออออออออัออออออออออออออออออออออออออออออออออออออออออออออออปฑฑ
ฑฑบPrograma  ณGETDFRET  บ Autor ณ Abrahao               บ Data da Criacao  ณ 17/10/2008                						บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯอออออออออออออออออออออออสออออออออออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
cQuery := "SELECT *  FROM "
cQuery += RetSqlName("ZL3") + " WHERE D_E_L_E_T_ = ' ' "
cQuery += "  AND ZL3_FILIAL = '" + xFilial("ZL3") + "'"
cQuery += "  AND ZL3_FRETIS = '" + a_cod + "'"
cQuery += "  AND ZL3_FRETLJ = '" + a_lj + "'"

dbUseArea(.T.,"TOPCONN",TCGenQry(,,ALLTRIM(Upper(cQuery))),'TRB',.F.,.T.)

If TRB->(!Eof())
	cLinRot := TRB->ZL3_COD
	cSetor	:= TRB->ZL3_SETOR
	cVeicul := TRB->ZL3_VEICUL
	bret := .t.
EndIf
TRB->(dbclosearea())

if !bRet
	if MsgYesNo("Atencao, esse Transportador nใo estแ vinculado a nenhuma linha! Continuar assim mesmo?")
		bRet:=.t.
	endif
endif
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัอออออออออออออออออออออออหออออออออออออออออออัออออออออออออออออออออออออออออออออออออออออออออออออปฑฑ
ฑฑบPrograma  ณisExist   บ Autor ณ Abrahao               บ Data da Criacao  ณ 24/12/2008                						บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯอออออออออออออออออออออออสออออออออออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
If cRet 
	if MsgYesNo("O ticket digitado jแ existe! Deseja continuar?")
    	nVolAnt 	:= nT1
		nLeiteBom 	:= nT1
    	nTotBom 	:= nT2
		nLtDif 		:= nTotBom-nLeiteBom
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัอออออออออออออออออออออออหออออออออออออออออออัออออออออออออออออออออออออออออออออออออออออออออออออปฑฑ
ฑฑบPrograma  ณgetNwTicket Autor ณ Abrahao               บ Data da Criacao  ณ 24/12/2008                						บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯอออออออออออออออออออออออสออออออออออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
aCols:={}
while TRB->(!Eof())
	Aadd(aCols,{TRB->A2_COD,TRB->A2_LOJA,0,TRB->A2_NOME,,,.F.})
	TRB->(dbskip())
enddo
TRB->(dbclosearea())
...
Local aArea := GetArea()
Local nRet:=0
Local dAux:=dDtColeta
Local nDias := 0

while dAux <= lastday(dDtColeta)
    nDias++
	if nDias == 1
		aCols[nDias,nPosDataCol] := dAux
	else
		Aadd(aCols,{dAux,"","",0,"",,,.F.})
    endif
    dAux++
