...
Static Function fProcessa()
	...
	cLocaliza := Posicione("SBZ",1,cFilials+SB1->B1_COD,"BZ_LOCALIZ") //BZ_FILIAL+BZ_COD
	
	if empty(cLocaliza)
	
		cLocaliza := SB1->B1_LOCALIZ
	...
	Do Case
		Case cLocaliza == "S" .AND. SB1->B1_RASTRO == "L"
...
Static Function GetDescProd()
	...
	cCrlEnd  := If(cLocaliza="S","Sim","Não")
...
Static Function fDetaB8BF(nPosAT)
	...
	IF  SB1->B1_RASTRO == "L"  .AND. cLocaliza == "S"
...
Static Function fDetaBJBK(nPosAT)
	...
	IF cLocaliza == "S"  .AND. SB1->B1_RASTRO="L"
...
Static Function fAjustD5DB(cOpcao)
	...
	aadd(aHeader, {"Origem"           , "ORIGEM"  , "@!"              , 03       , 0         ,"U_xValidACo()"       , ""      , "C"    , ""        ,,})
	aadd(aHeader, {"Data"             , "DATA"    , "99/99/99"        , 08       , 0         ,"U_xValidACo()"       , ""      , "D"    , ""        ,,})
	aadd(aHeader, {"Docto."           , "DOCTO"   , "@!"              , 06       , 0         ,"U_xValidACo()"       , ""      , "C"    , ""        ,,})
	aadd(aHeader, {"Serie"            , "SERIE"   , "@!"              , 03       , 0         ,""       , ""      , "C"    , ""        ,,})
	aadd(aHeader, {"Clie.For"         , "CLIEFOR" , "@!"              , 06       , 0         ,""       , ""      , "C"    , ""        ,,})
	aadd(aHeader, {"Loja"             , "LOJA"    , "@!"              , 02       , 0         ,""       , ""      , "C"    , ""        ,,})
	aadd(aHeader, {"TES"              , "TES"     , "@!"              , 03       , 0         ,"U_xValidACo()"       , ""      , "C"    , ""        ,,})
	aadd(aHeader, {"CF"               , "CF"      , "@!"              , 03       , 0         ,"U_xValidACo()"       , ""      , "C"    , ""        ,,})
	aadd(aHeader, {"Lote"             , "LOTE"    , "@!"              , 10       , 0         ,"U_xValidACo()"       , ""      , "C"    , ""        ,,})
	aadd(aHeader, {"Num.Lote"         , "NUMLOTE" , "@!"              , 06       , 0         ,""       , ""      , "C"    , ""        ,,})
	aadd(aHeader, {"Endereço"         , "ENDERECO", "@!"              , 15       , 0         ,"U_xValidACo()"       , ""      , "C"    , ""        ,,})
	aadd(aHeader, {"Qtde."            , "QTDE"    , cPict             , 18       , 2         ,"U_xValidACo()"       , ""      , "N"    , ""        ,,})
	aadd(aHeader, {"Qtde.UM2"         , "QTDE2UM" , cPict2UM          , 18       , 2         ,"U_xValidACo()"       , ""      , "N"    , ""        ,,})
