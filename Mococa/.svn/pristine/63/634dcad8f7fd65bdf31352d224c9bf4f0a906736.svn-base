...
/*/{Protheus.doc} RELPREJ
Relatório - Clientes Pedidos Rejeitados   
@author TREPORT
@since 19/06/2018
@version 1.0
	@example
...
Static Function fReportDef()
	...
	oReport := TReport():New(	"RELPREJ",;		//Nome do Relatório
								"Clientes Pedidos Rejeitados",;		//Título
...
Static Function fRepPrint(oReport)
	...
	//MemoWrite("C:\teste\RELPREJ_V1_1.sql",cQryAux) //19/06/2018 
