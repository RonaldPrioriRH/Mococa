...
±±³Programa  ³MVULTDEPR  ³ Autor ³ Claudio Ferreira      ³ Data ³14/03/2012³±±
...
User Function MVULTDEPR 
// Variaveis Locais da Funcao                             
Local cEdit1	 := GetMv("MV_ULTDEPR")
Local cEdit2	 := GetMv("MV_ULTDEPR")
Local oEdit1
Local oEdit2
Private _oDlg				// Dialog Principal

DEFINE MSDIALOG _oDlg TITLE "MV_ULTDEPR" FROM C(350),C(575) TO C(487),C(721) PIXEL
