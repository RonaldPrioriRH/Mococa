...
User Function XIQIPR050() 
	...
	Private lProduto   := .F.
    Private lLabmic := .F.
    Private cIdioma := "Inglês"//Portugês//Espanhol
    Private cGrupo := ""
...
//***********************************************************************************		
		...
		@Li,01 PSAY "[ "+STR0062+" ]"
		Li++
		@Li,01 PSAY "[kg =  kilograms/quilograma] [FQ = Physico-chemical/Físico-Quimico] [N.M.P. = Most probable number/Número mais provavel]" 
		Li++
		@Li,01 PSAY "[Mín. = Minimum/Mínimo] [µg = microgram/micrograma] [MB = Microbiology/Microbiologia] [Máx. = Maximum/Máximo]" 
		Li++
		@Li,01 PSAY "[U.F.C = Colony-forming unit/Unidade formadora de colonia] [Col. = Coliforms/Coliformes] [mg = miligrams/miligramas]" 
		Li++
		@Li,01 PSAY "[N.D. =  No Detected/Não Detectado] [cps = centipoise/centipoise] [ml = milliliter/mililitro] [µ = micro/micro]" 
		Li++
